...
No longer viable, custom library fork is used in dependencies with this fix already applied. If compilation gives any errors, issue most certainly lies in the outdated ESP-IDF library version on your machine.
Make sure that your PlatformIO is updated to the latest version and that it uses the ESP-IDF 3.0+ library.
